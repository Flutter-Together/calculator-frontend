...
class Mobile_HoldingTaxPage extends StatefulWidget {
  const Mobile_HoldingTaxPage({Key? key}) : super(key: key);

  @override
  State<Mobile_HoldingTaxPage> createState() => _Mobile_HoldingTaxPageState();
}

class _Mobile_HoldingTaxPageState extends State<Mobile_HoldingTaxPage> {
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            index_selected >= 1
                              ...
                              children: [Text('주소1'), Search_Address(width: 350, stage: stage1,)],
                            ),
                            index_selected == 1
                                ? Column(
                              crossAxisAlignment:
  ...
  SizedBox Label(String label) =>
      SizedBox(width: 120, child: MediumText(text: label, size: 17,));
    ...
    children: [
      SizedBox(
        ...
        child: Badge(
            ...
            child: MediumText(text: label, size: 17,)),
      ),
      SizedBox(
        width: 30,
      )
