                                    ...
                                    builder: (BuildContext context, BoxConstraints constraints){
                                      return DropdownButtonHideUnderline(
                                        child: DropdownButton2(
                                          isExpanded: true,
                                          items: ['1채','2채','3채'].map((item) => DropdownMenuItem<String>(
                                            value: item,
                                            child: Text(
                                              item,
...
class CapGainBody extends StatefulWidget {
  ...
  @override
  State<CapGainBody> createState() => _CapGainBodyState();
}

class _CapGainBodyState extends State<CapGainBody> {
  String addr_hinttext = '서울특별시 서초구 반포대로4(서초동) 101동 206호';
  Color samplecolor = Colors.black38;
  bool isSearchedAddress = false;
  bool isSearchedDong = false;
